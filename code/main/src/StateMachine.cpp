...
// StateMachine::StateMachine(int keroIso, int loxIso, int keroMain, int loxMain,
//                             int keroVent, int loxVent, int purge)
// {
//     state(DEFAULT){}
...
// void StateMachine::processComand(Command command)
// {
//     switch(state)
//     {
//         case DEFAULT:
